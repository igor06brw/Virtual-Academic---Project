				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>List of employees
							</div>
						</div>
...
$(document).ready(function(){
		...
		function applyFilter(){
			...
			myGrid.clearAll();
			myGrid.load("http://10.1.2.24/beta/back/employees/getEmployees?emp_id=" + emp_id, callback,'json');
		...
		myGrid.setHeader("Employee,Type,Edit,Login As");
