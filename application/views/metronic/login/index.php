...
<link href="<?= assets_url() ?>metronic/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<link href="<?= assets_url() ?>metronic/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="index.html">
	<img src="<?= assets_url() ?>metronic/admin/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	...
	<form class="login-form" action="<?= $loginController ?>" method="post">
		<h3 class="form-title">Sign In (test)</h3>
	<?php if($alert): ?>
...
<script src="<?= assets_url() ?>metronic/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="<?= assets_url() ?>metronic/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
