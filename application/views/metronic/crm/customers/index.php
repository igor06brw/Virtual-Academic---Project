				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>List of customers
							</div>
						</div>
...
$(document).ready(function(){
		...
		function applyFilter(){
			...
			myGrid.clearAll();
			myGrid.load("http://10.1.2.24/beta/back/crm/customers_dhtmlxGet?customer_id=" + customer_id, callback,'json');
		...
		myGrid.setHeader("ACC,Company,Main Contact,Email,Address,City,Phone,Status");
