				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>List of suppliers
							</div>
						</div>
...
$(document).ready(function(){
		...
		function applyFilter(){
			...
			var supplier_id = ($("#supplier_id").val().length === 0) ? '' : encodeURIComponent($("#supplier_id").val());
			
			myGrid.clearAll();
			myGrid.load("http://10.1.2.24/beta/back/crm/suppliers_dhtmlxGet?supplier_id=" + supplier_id, callback,'json');
		...
		myGrid.setHeader("ID,Main Contact,Company,Email,Address,City,Phone,Status");
		...
		var b = new Bloodhound({
                ...
                remote: "http://10.1.2.24/beta/back/autocomplete/supplier/%QUERY/"
        });
		...
		b.initialize();	
			$("#typeahead_example_3").typeahead(null, {
				...
				$("#supplier_id").val(selected.supplier_id);
			});	
