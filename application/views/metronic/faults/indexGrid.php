				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>List of faults
							</div>
						</div>
...
$(document).ready(function(){
		...
		function applyFilter(){
			...
			*/
			...
			var date_to = ($("input[name='to']").val().length === 0) ? '' : encodeURIComponent($("input[name='to']").val());	
			myGrid.clearAll();
			myGrid.load("http://10.1.2.24/beta/back/faults/getDhtmlx?" + "date_from=" + date_from + "&date_to=" + date_to + "&status=" + status + "&emp_id=" + emp_id, callback,'json');
		...
		myGrid.setHeader("ID,Barcode,Assembly,Customer,Qty,Employee,Inspector,Approved by,Categories,Status,Date");
		...
		myGrid.setColTypes('ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,dhxCalendar');
		...
		var a = new Bloodhound({
                ...
                remote: "http://10.1.2.24/beta/back/autocomplete/employee_barcoding/%QUERY/"
        });
