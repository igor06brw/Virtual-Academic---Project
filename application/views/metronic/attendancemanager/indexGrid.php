...
$(document).ready(function(){
		...
		function applyFilter(){
			...
			var barcode = '';
			myGrid.clearAll();
			myGrid.load("http://10.1.2.24/beta/back/attendancemanager/getDhtmlx/?emp_id=" + emp_id + "&barcode=" + barcode + '&type=' + type + '&status=' + status + "&date_from=" + date_from + "&date_to=" + date_to, callback,'json');
		...
		myGrid.setHeader("Session ID,Date Start, Time start,Time stop, Time spent,Employee,Type");
		//myGrid.attachHeader(',#text_filter,#text_filter,,,#text_filter,#text_filter')
		myGrid.setColTypes('ro,dhxCalendar,ro,ro,ro,ro,ro');
		...
		applyFilter();
		var dp = new dataProcessor("http://10.1.2.24/beta/back/attendancemanager/ajaxProcessor");
		dp.init(myGrid);
